...
def detail_url(recipe_id):
    """Create and reeturn recipe detail url."""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email='user@wxample.com', password='test123')
    ...
    def test_recipe_list_limited_to_user(self):
        """Test recipes are lemited to authenticate user."""
    ...
    def test_create_recipe_with_existing_tag(self):
        """Test create recipe whis existing tag."""
    ...
    def test_create_tag_on_update(self):
        """Test creating a tag when updating the recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 50,
            'price': Decimal('7.50'),
            'ingredients': [{'name': 'Salt'}, {'name': 'Apples'}]
        }
    ...
    def test_create_ingredients_on_update(self):
        """Test creating ingredients when updating the recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        tag1 = Tag.objects.create(user=self.user, name='Salt')
        tag2 = Tag.objects.create(user=self.user, name='pepper')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Cake')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Cookie')
